...
class LunaApp:
    ...
    def create_chat_view(self):
        ...
        # Add welcome message
        self.add_message("Luna", "Welcome to your personal period tracking assistant! I'm here to help you monitor your cycle, track symptoms, and answer health questions. How are you feeling today? 💖", is_user=False)
    ...
    def clear_chat(self):
        ...
        self.chat_history.clear()
        self.add_message("Luna", "Chat cleared! Ready to help you again! 💖", is_user=False)
    ...
    def send_message(self):
        ...
        self.root.after(800, lambda: self.add_message("Luna", bot_response, is_user=False))
